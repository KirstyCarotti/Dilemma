...
public class DBHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String sqlUser = "CREATE TABLE IF NOT EXISTS User(_UserID INTEGER, Username TEXT, Password TEXT, _CategoryID INTEGER, Salt TEXT, PRIMARY KEY(_UserID));";
        ...
        String sqlAnsQue = "CREATE TABLE IF NOT EXISTS AnsQue(_UserID INTEGER, _QuestionID INTEGER, AnswerType INTEGER, PRIMARY KEY(_UserID, _QuestionID), FOREIGN KEY(_UserID) REFERENCES User(_UserID), FOREIGN KEY(_QuestionID) REFERENCES Question(_QuestionID));";
    ...
    public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
        ...
        db.execSQL("DROP TABLE IF EXISTS AnsQue");
        onCreate(db);
    }
